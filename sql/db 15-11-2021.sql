...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 15, 2021 at 12:08 AM
...
CREATE TABLE `lv_empsetting` (
  ...
  `last_yr_bal` int(11) NOT NULL,
  `curr_yr_bal` int(11) NOT NULL,
  `prorate` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `lv_empsetting` (`id`, `id_user`, `year`, `leave_entitle`, `last_yr_bal`, `curr_yr_bal`, `prorate`) VALUES
(73, 'user1', 2021, 25, 10, 20, 0),
(74, 'admin1', 2021, 30, 5, 25, 0),
(75, 'nyamo', 2021, 40, 0, 30, 0);
